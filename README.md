...
Here are the results from the loopback test cases, and the generated waveform can be seen at docs/waveform.png
...
add wave /uart_tb/dut/baud/baud_tick
add wave /uart_tb/dut/baud/os_tick
